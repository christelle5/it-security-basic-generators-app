...
class SignatureFrameText(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.label_message = ttk.Label(self, text="Message to sign:")
        ...
        self.sign_button = ttk.Button(self, text="Sign Message", command=self.sign_message)
        ...
        self.sign_file_button = ttk.Button(self, text="Sign the File",
    ...
    def sign_message(self):
        try:
            ...
            messagebox.showerror("Error", "Please, enter the message you want to sign (256 chars maximum) and valid"
                                          "filename for file with private key (in .pem format).")
            return

        if len(message) > 256:
            messagebox.showerror("Error", "The length of message is too big. Please, try to make a txt file with "
                                          "message, go to Sign the File page using button Sign the File, and "
                                          "try again.")
            return
        ...
        result = sign_gen_obj.sign(private_key, message)
